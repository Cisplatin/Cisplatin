"""
Django settings for Cisplatin project.
...
ROOT_URLCONF = 'Cisplatin.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "Cisplatin_App/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Cisplatin.wsgi.application'
